...
function getItemObject(itemElem) {
	let item = itemElem.querySelector('a[title*=" / "]') ?? itemElem.querySelector('a[title*=" | "]'); //isSearch ? itemElem.querySelector('a[title*=" / "]') : itemElem.querySelector('a[title*="COLLECTION"]');
